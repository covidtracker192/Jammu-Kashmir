package com.covid19.jammuandkashmir;
...
public class Test_MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Test Center 1
        final LatLng center1 = new LatLng(34.777226, 74.895860);
        mMap.addMarker(new MarkerOptions().position(center1).title("Sher-e- Kashmir Institute of Medical Sciences, Srinagar").snippet("website: http://www.skims.ac.in/"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(center1));

        //Test Center 2
        final LatLng center2 = new LatLng(32.736338, 74.853888);
        mMap.addMarker(new MarkerOptions().position(center2).title("Government Medical College, Jammu").snippet("website: http://www.gmcjammu.nic.in/"));
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                if(marker.getPosition().equals(center1)) {
                    Uri uriUrl = Uri.parse("http://www.skims.ac.in/");
                    Intent launchBrowser = new Intent(Intent.ACTION_VIEW, uriUrl);
                    startActivity(launchBrowser);
                }
                else if(marker.getPosition().equals(center2)) {
                    Uri uriUrl = Uri.parse("http://www.gmcjammu.nic.in/");
                    Intent launchBrowser = new Intent(Intent.ACTION_VIEW, uriUrl);
                    startActivity(launchBrowser);
                }
            }
